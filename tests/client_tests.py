...
class ClientStateTestCase(base.AsyncHTTPTestCase):
    ...
    def test_idle(self):
        self.client.state = client.Client.STATE_IDLE
    ...
    def test_closed(self):
        self.client.state = client.Client.STATE_CLOSED
    ...
    def test_closable_true(self):
        for state in {client.Client.STATE_READY, client.Client.STATE_BLOCKED}:
            self.client.state = state
            self.assertTrue(self.client.closable)

    def test_closable_false(self):
        for state in {client.Client.STATE_IDLE,
                      client.Client.STATE_CONNECTING,
                      client.Client.STATE_CLOSING,
                      client.Client.STATE_CLOSED}:
            self.client.state = state
