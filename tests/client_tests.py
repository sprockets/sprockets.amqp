...
class ClientStateTestCase(base.AsyncHTTPTestCase):
    ...
    def test_idle(self):
        self.client.state = client.STATE_IDLE
    ...
    def test_connecting(self):
        self.client.state = client.STATE_CONNECTING
    ...
    def test_closing(self):
        self.client.state = client.STATE_CLOSING
    ...
    def test_closed(self):
        self.client.state = client.STATE_CLOSED
    ...
    def test_closable_true(self):
        for state in {client.STATE_READY, client.STATE_BLOCKED}:
            self.client.state = state
            self.assertTrue(self.client.closable)

    def test_closable_false(self):
        for state in {client.STATE_IDLE, client.STATE_CONNECTING,
                      client.STATE_CLOSING, client.STATE_CLOSED}:
            self.client.state = state
...
class ClientStateTransitionsTestCase(base.AsyncHTTPTestCase):
    ...
    def test_close_when_in_wrong_state(self):
        self.client.state = client.STATE_CLOSING
        self.assertTrue(self.client.closing)
        with self.assertRaises(exceptions.ConnectionStateError):
            self.client.close()
